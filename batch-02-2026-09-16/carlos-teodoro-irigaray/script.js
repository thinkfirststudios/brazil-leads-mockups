/* Irigaray e Associados — mockup script (no framework, no build step)
...
(function () {
  ...
  var STORE_KEY = 'ia_cookie_consent_v1';
  ...
  /* ---------- CTA por área: pré-seleciona a matéria no formulário ---------- */
  document.querySelectorAll('[data-area]').forEach(function (link) {
    link.addEventListener('click', function () {
      var sel = document.getElementById('f-materia');
      if (!sel) return;
      var v = link.getAttribute('data-area');
