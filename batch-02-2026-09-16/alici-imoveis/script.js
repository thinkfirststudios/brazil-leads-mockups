/* Alici Imóveis — mockup behaviour. Vanilla JS, no dependencies. */
(function () {
  'use strict';
  var doc = document;
  var reduce = window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  var WA = { locacao: '5548991520035', vendas: '5548996241884' };
  ...
  $$('form[data-demo]').forEach(function (f) {
    f.addEventListener('submit', function (e) {
      ...
      if (line === 'by-finalidade') { var fin = f.querySelector('[name="finalidade"]'); line = fin && fin.value === 'Comprar' ? 'vendas' : 'locacao'; }
  ...
  var KEY = 'alici-cookie-consent-v1';
  var banner = $('#cookie');
