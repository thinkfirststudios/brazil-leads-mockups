/* Marcio Mussel — Numerólogo · mockup script (no framework, no build step) */
(function () {
  'use strict';
  var d = document;
  ...
  /* [CONFIRM whether Marcio accepts WhatsApp at all] — none is published.
     While null, WhatsApp-style CTAs keep their href to the booking form (#agendamento). */
  var WA_NUMBER = null;
  var COOKIE_KEY = 'mm_cookie_consent_v1';
